# sawasdee-os &nbsp; [![bluebuild build badge](https://github.com/veer66/sawasdee-os/actions/workflows/build.yml/badge.svg)](https://github.com/veer66/sawasdee-os/actions/workflows/build.yml)
